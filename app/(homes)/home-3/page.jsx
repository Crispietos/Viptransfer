...
// import Blogs from "@/components/homes/common/blogs/Blogs"; // Usunięty komponent Blogs
...
export const metadata = {
  title: "Home 3 || Lixride Chauffeur Limousine Transport and Car Hire Nextjs Template",
  description: "Lixride Chauffeur Limousine Transport and Car Hire Nextjs Template",
};
  ...
  return (
    <>
      ...
      <main className="main">
        ...
        <Testimonials />
        <Cities />
        {/* <Blogs /> */} {/* Usunięty komponent Blogs */}
        <DownloadApp />
      </main>
      <Footer3 />
    </>
