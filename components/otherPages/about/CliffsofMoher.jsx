      ...
      <main>
        ...
        <section className="section pt-120 pb-60 bg-light text-center">
          <div className="container-sub">
            <h1 className="heading-44-medium mb-2 text-gray-800">
              Cliffs of Moher – Private Day Trip from Dublin
            </h1>
            <h4 className="text-20 font-medium color-text mb-8">
              with Galway or Optional Scenic Stops
            </h4>
            
            <p className="text-18 color-text max-w-4xl mx-auto mb-8">
            ...
            <div className="max-w-4xl mx-auto text-left bg-white p-6 rounded-lg shadow-sm border-l-4 border-blue-500">
              <h5 className="text-18 font-bold mb-4 text-gray-800">You can choose how you would like to spend your day:</h5>
              <ul className="text-18 color-text space-y-3 pl-8 list-disc">
                <li><strong>Cliffs of Moher and Galway:</strong> a balanced option with time at both locations</li>
                <li className="list-none text-center font-bold my-2">OR</li>
                <li><strong>Cliffs of Moher with selected stops along the way:</strong> such as The Burren, Doolin, Lahinch, Bunratty Castle or other places of interest.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        {/* O miejscach i tempie */}
        <section className="section pt-0 pb-60">
          <div className="container-sub">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
              <div>
                <h3 className="heading-28-medium mb-4 text-gray-800">The Cliffs</h3>
              ...
              <div>
                <h3 className="heading-28-medium mb-4 text-gray-800">The City</h3>
                <p className="text-18 color-text leading-relaxed">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg italic">
              <p className="text-18 color-text font-medium">
        ...
        {/* Planowanie i Przystanki */}
        <section className="section pt-60 pb-60 bg-light">
          <div className="container-sub">
            <h2 className="heading-32-medium mb-6 text-gray-800">Planning Your Day</h2>
            <div className="text-18 color-text space-y-4 mb-10">
              <p>
                The journey to the Cliffs of Moher takes approximately 3.5 hours from Dublin, with scenic stops along the way, making the day feel relaxed and well-paced. <strong>Estimated duration: approximately 10–13 hours.</strong>
              </p>
              <p>
                Due to the travel distance, the day is planned in a realistic and comfortable way, allowing you to enjoy each stop without rushing. It is not possible to include Cliffs of Moher, Galway and multiple additional stops in one day without significantly reducing the time spent at each location.
              </p>
              <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                <h3 className="heading-24-medium mb-4 text-gray-800">Optional Stops</h3>
              ...
              <div>
                <h3 className="heading-24-medium mb-4 text-gray-800">Return to Dublin</h3>
        ...
        {/* Pricing Section - BEZ ZMIAN */}
        <section className="section-primary pt-60 pb-60">
          <div className="container-sub">
            <h2 className="heading-32-medium mb-10 text-center text-white">Price</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              
              {/* Card 1: Premium Car */}
              <div className="card bg-white p-6 rounded-lg text-center">
                <h3 className="text-2xl font-semibold text-gray-800 mb-6">
                  First Class <span className="text-gray-600 block text-lg mt-2">(up to 3 people)</span>
                </h3>
                <p className="price text-3xl font-bold text-blue-600 mb-4">€695</p>
              ...
              <div className="card bg-white p-6 rounded-lg text-center">
                <h3 className="text-2xl font-semibold text-gray-800 mb-6">
                  Premium MPV <span className="text-gray-600 block text-lg mt-2">(up to 7 people)</span>
                </h3>
                <p className="price text-3xl font-bold text-blue-600 mb-4">€795</p>
                <p className="text-16 text-gray-600 leading-relaxed">
              ...
              <div className="card bg-white p-6 rounded-lg text-center">
                <h3 className="text-2xl font-semibold text-gray-800 mb-6">
                  Executive MPV <span className="text-gray-600 block text-lg mt-2">(up to 6 people)</span>
                </h3>
                <p className="price text-3xl font-bold text-blue-600 mb-4">€895</p>
                <p className="text-16 text-gray-600 leading-relaxed">
        ...
        <section className="section-primary pt-60 pb-60" style={{ borderTop: "1px solid rgba(255,255,255,0.1)" }}>
          <div className="container-sub text-white">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              
              {/* ZAWIESA */}
              <div className="bg-white/10 p-8 rounded-lg backdrop-blur-sm">
                <h2 className="heading-28-medium mb-6">What’s Included</h2>
                <ul className="text-18 space-y-3 pl-2">
          ...
          <div className="text-center mt-16">
            <Link href="/bookingdaytrip" passHref>
              <span className="btn btn-light rounded-3 px-8 py-4 fw-semibold text-lg" style={{ color: '#0EA5E9', cursor: 'pointer' }}>Make a booking</span>
            </Link>
          </div>
        </section>
      </main>
